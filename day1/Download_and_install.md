For this exercise, you will need to download an application called Integrative Genomics Viewer (IGV) and four data files that are stored in the day1/Exercise directory.
